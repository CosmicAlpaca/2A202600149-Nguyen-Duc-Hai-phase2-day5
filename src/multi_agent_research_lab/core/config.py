...
class Settings(BaseSettings):
    ...
    gemini_model: str = Field(default="gemma-4-26b", validation_alias="GEMINI_MODEL")
    gemini_fast_model: str = Field(default="gemma-4-26b", validation_alias="GEMINI_FAST_MODEL")
